...
class Vgg16:
    ...
    '''
    def __init__(self, rgbImagesPlaceholder, model_path=None):
        self.data_dict = np.load(model_path, encoding='latin1').item()
        self._buildVgg16FeatureExtractor(rgbImagesPlaceholder)
    ...
    '''
    def _buildVgg16FeatureExtractor(self, rgbImages):
